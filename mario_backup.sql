...
--
-- Name: characters_mode_info_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.characters_mode_info_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.characters_mode_info_id_seq OWNER TO freecodecamp;

--
-- Name: characters_mode_info_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.characters_mode_info_id_seq OWNED BY public.characters.mode_info_id;
...
--
-- Name: characters mode_info_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.characters ALTER COLUMN mode_info_id SET DEFAULT nextval('public.characters_mode_info_id_seq'::regclass);
...
COPY public.characters (character_id, name, homeland, favorite_color, mode_info_id) FROM stdin;
2	Luigi	Mushroom Kingdom	Green	1
3	Peach	Mushroom Kingdom	Pink	2
7	Yoshi	Dinosaur Land	Green	3
6	Daisy	Sarasaland	Orange	4
1	Mario	Mushroom Kingdom	Red	5
4	Toad	Mushroom Kingdom	Blue	6
5	Bowser	Koopa Kingdom	Yellow	7
\.
...
--
-- Name: characters_mode_info_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.characters_mode_info_id_seq', 7, true);
...
--
-- Name: characters characters_character_id_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: characters characters_character_id_key1; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.characters
    ADD CONSTRAINT characters_character_id_key1 UNIQUE (character_id);
